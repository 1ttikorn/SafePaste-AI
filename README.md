...
<div align="center" style="margin-top: 15px;">
    <a href="https://www.nxgntools.com/tools/safepaste-ai-privacy-shield?utm_source=safepaste-ai-privacy-shield" target="_blank" rel="noopener" style="display: inline-block; width: auto;">
        <img src="https://www.nxgntools.com/api/embed/safepaste-ai-privacy-shield?type=PLACED_3RD_ON" alt="NextGen Tools #3 Tool of the Week Badge - Top Trending Tool" style="height: 48px; width: auto;" />
    </a>
</div>
...
| Feature | 🆓 FREE Plan | ♔ PRO Shield |
| :--- | :---: | :---: |
| **Local Processing** | ✅ 100% Private | ✅ 100% Private |
| **Basic PII** (Emails, Phones) | ✅ | ✅ |
| **Passwords & API Keys** (Stripe, AWS, etc.) | ✅ **Included** | ✅ |
| **File Sanitization** | ✅ (Max 50KB) | ✅ (**Max 2MB**) |
| **Finance** (Credit Cards, IBAN, Bank Accs) | ❌ | ✅ |
| **Identity** (Passport Numbers, IDs) | ❌ | ✅ |
| **Crypto Guard** (Seed Phrases, Private Keys) | ❌ | ✅ |
| **Infrastructure** (IP Addresses, DB URIs) | ❌ | ✅ |
| **Workspace Tabs** | Single Tab | **Multi-Tab (20+)** |
| **Custom Rules** (Hide/Show Words) | ❌ | ✅ |
...
Maximize your productivity with these native shortcuts:

| Shortcut | Action |
| :--- | :--- |
| **`Alt + Shift + S`** | Open **Secure Workspace** (File & Text Editor) |
| **`Alt + Shift + O`** | Toggle **AI Chat Protection** (On/Off) |
...
<p align="center">
  Built with ❤️ for Privacy & AI Safety
</p>
